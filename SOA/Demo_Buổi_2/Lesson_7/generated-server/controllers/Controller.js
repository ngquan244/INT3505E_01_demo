...
class Controller {
  ...
  */
  ...
  const requestParams = {};
  if (request.body) Object.assign(requestParams, request.body);
  if (request.params) Object.assign(requestParams, request.params);
  if (request.query) Object.assign(requestParams, request.query);
